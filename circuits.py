...
class U1_circuit(tf.keras.layers.Layer):
    ...
    # initialize class
    def __init__(self, filter_size, n_kernels, n_input_channels, datatype, registers=1, rdpa=1, classical_weights=False, inter_U=False, activation=None, name=None, kernel_regularizer=None, **kwargs):
    ...
    def Q_circuit(self):
        ...
        def Q_embed(self,layer_index, register_index,qubits):
          ...
          #total_layers = self.n_input_channels/self.registers
          #min_rot = (np.pi/total_layers)*layer_index
          #max_rot = (np.pi/total_layers)*(layer_index + 1)
          #rotation_angle = 
          ...
          #for i in range(len(qubits)):
          #  self.circuit.append(cirq.rx(input_params[starting_parameter+i]*(max_rot-min_rot)+min_rot)(qubits[i]))
        ...
        #for i in range(self.registers):
        #    for j in range(len(qubit_registers[i])):
        #        self.circuit.append(cirq.H(qubit_registers[i][j]))
...
class U2_circuit(tf.keras.layers.Layer):
    ...
    # initialize class
    def __init__(self, filter_size, n_kernels, n_input_channels, datatype, registers=1, rdpa=1, ancilla=1,classical_weights=False, inter_U=False, activation=None, name=None, kernel_regularizer=None, **kwargs):
...
class Q_U1_control(tf.keras.layers.Layer):
    ...
    # initialize class
    def __init__(self, filter_size, n_kernels, datatype, padding=False, classical_weights=False, activation=None, name=None, kernel_regularizer=None, **kwargs):
...
class Q_U2_control(tf.keras.layers.Layer):
    def __init__(self, filter_size, depth, datatype, classical_weights=False,activation=None, name=None, kernel_regularizer=None, **kwangs):
